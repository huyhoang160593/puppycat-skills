...
2. Write the findings to a single Markdown file, citing each claim's source. If the investigation surfaces gaps or related questions worth pursuing, list them at the end.
